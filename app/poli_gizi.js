function load_data() {
    $.post(base_url + "poli_gizi/load_data", {}, function (data) {
        console.log(data);
...
function edit_data(id) {
	$.post(base_url + 'poli_gizi/edit_table', { id: id }, function (data) {
...
function update_data() {
	...
	if (rekamMedisTanggalPeriksa === "" || rekamMedisKode === "" || rekamMedisKeluhan === "" || rekamMedisPoli === "" || rekamMedisFaskes === "") {
		...
		$.post(base_url + 'poli_gizi/update_table', { id: id, rekamMedisTanggalPeriksa: rekamMedisTanggalPeriksa, rekamMedisKode: rekamMedisKode, rekamMedisKeluhan: rekamMedisKeluhan, rekamMedisPoli: rekamMedisPoli, rekamMedisFaskes: rekamMedisFaskes, }, function (data) {
...
function active_data(id, status) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post(base_url + "poli_gizi/active", { id: id, status: newStatus }, function(data) {
                if (data.status === 'success') {
                    Swal.fire({
                        title: 'Success!',
                        text: data.msg,
